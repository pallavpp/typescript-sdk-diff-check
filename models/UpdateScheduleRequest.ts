...
export enum UpdateScheduleRequestMetadataTypeEnum {
    Liveboard = 'LIVEBOARD'
}
export enum UpdateScheduleRequestFileFormatEnum {
    Csv = 'CSV',
    Pdf = 'PDF',
    Xlsx = 'XLSX'
}
export enum UpdateScheduleRequestTimeZoneEnum {
...
export enum UpdateScheduleRequestStatusEnum {
    Active = 'ACTIVE',
    Pause = 'PAUSE'
}
